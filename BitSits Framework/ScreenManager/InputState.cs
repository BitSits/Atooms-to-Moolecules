...
namespace BitSits_Framework
{
    ...
    public class InputState
    {
        ...
        public InputState()
        {
            ...
            LastMouseState = new MouseState[1];
        ...
        {
            return (LastMouseState[0].LeftButton == ButtonState.Released &&
                   CurrentMouseState[0].LeftButton == ButtonState.Pressed);
        }

        public bool IsRightClicked()
        {
            return (LastMouseState[0].RightButton == ButtonState.Released &&
                   CurrentMouseState[0].RightButton == ButtonState.Pressed);
        }
